...
export interface CreateAssessmentPayload {
  ...
  urinaryAnalysis?: { protein?: string; leukocytes?: string; haematuria?: string };
}
...
export const patientService = {
  ...
  submitUrinaryAnalysis: (assessmentId: number, payload: { protein?: string; leukocytes?: string; haematuria?: string }): Promise<SectionResponse> =>
  ...
  getUrinaryAnalysis: (assessmentId: number): Promise<{ urinaryAnalysis: { protein?: string; leukocytes?: string; haematuria?: string } }> =>
  ...
  updateUrinaryAnalysis: (assessmentId: number, payload: { protein?: string; leukocytes?: string; haematuria?: string }): Promise<SectionResponse> =>
  ...
  submitInlineUrinaryAnalysis: (
    payload: { patientId: number; userId?: number; protein?: string; leukocytes?: string; haematuria?: string },
  ): Promise<SectionResponse> =>
